...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/publicui/dashboard/resources/dashboard.css" />
	<link rel="stylesheet" type="text/css" href="/publicui/dashboard/resources/js/jqPlot-1.0.0a/jquery.jqplot.css" />
	
	<script type="text/javascript" src="/publicui/dashboard/resources/js/jquery-1.4.4.min.js"></script>
	<script type="text/javascript" src="/publicui/dashboard/resources/js/jquery.sparkline.min.js"></script> 
	<script type="text/javascript" src="/publicui/dashboard/resources/js/dygraph-combined.js"></script>
	<script type="text/javascript" src="/publicui/dashboard/resources/js/jqPlot-1.0.0a/jquery.jqplot.min.js"></script>
	<script type="text/javascript" src="/publicui/dashboard/resources/js/jqPlot-1.0.0a/plugins/jqplot.cursor.min.js"></script>
	<script type="text/javascript" src="/publicui/dashboard/resources/js/jqPlot-1.0.0a/plugins/jqplot.pieRenderer.min.js"></script>
	...
	<script type="text/javascript" src="/publicui/dashboard/resources/js/jqPlot-1.0.0a/plugins/jqplot.dateAxisRenderer.min.js"></script>
	...
	<script type="text/javascript" src="/publicui/dashboard/resources/js/jqPlot-1.0.0a/plugins/jqplot.highlighter.min.js"></script>
...
<nav id="main">
	<img src="/publicui/dashboard/resources/funnelback-logo.png" />
	<ul>
