 ...
 */
@Log4j2
@Component("legacyFacetedNavigationInputProcessor")
public class LegacyFacetedNavigation extends AbstractInputProcessor {
            ...
            if (config != null) {
                ...
                if (facetParamaters.size() > 0) {
                    for (final FacetParameter facetParameter : facetParamaters) {
                        ...
                        // Only process legacy type faceted navigation
