...
import com.funnelback.springmvc.utils.web.RequestParameterValueExtractor;
...
public class DefaultSearchTransactionProcessor implements SearchTransactionProcessor {
    ...
    public SearchTransaction process(SearchQuestion question, SearchUser user) {
        ...
        try {
            ...
            ThreadContext.put(RequestParameterValueExtractor.COLLECTION, question.getCollection().getId());
            ThreadContext.put(RequestParameterValueExtractor.PROFILE, question.getProfile());
