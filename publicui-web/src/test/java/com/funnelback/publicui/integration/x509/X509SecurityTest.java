...
public class X509SecurityTest {
    ...
    public static void startServer() throws Exception {
        X509SecurityTest.server = new X509ConfiguredJettyServer(searchHome);
        X509SecurityTest.server.start();
    }
    ...
    private String performTestRequest(Optional<String> keystorePath) throws Exception {
        ...
        HttpGet get = new HttpGet(X509SecurityTest.server.getBaseUrl() + "/s/search.html");
