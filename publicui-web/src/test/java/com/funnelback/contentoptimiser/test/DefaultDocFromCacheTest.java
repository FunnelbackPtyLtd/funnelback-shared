...
public class DefaultDocFromCacheTest {
	...
	public void testGetDocumentForks() throws FileNotFoundException, EnvironmentVariableException {
		...
		comparison.setImportantOne(new Result(null, null, cacheCgi, cacheCgi, null, cacheCgi, cacheCgi, cacheCgi, null, null, cacheCgi, null, null, null, null, null, null, cacheCgi, cacheCgi, null, cacheCgi));
