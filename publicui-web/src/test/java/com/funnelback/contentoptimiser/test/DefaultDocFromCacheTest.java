...
public class DefaultDocFromCacheTest {
    ...
    public void testGetDocumentForks() throws FileNotFoundException, EnvironmentVariableException {
        ...
        comparison.setSelectedDocument(new Result(null, null, cacheCgi, cacheCgi, null, null, cacheCgi, cacheCgi, cacheCgi, null, null, cacheCgi, null, null, null, null, null, cacheCgi, cacheCgi, null, cacheCgi, null, false));
