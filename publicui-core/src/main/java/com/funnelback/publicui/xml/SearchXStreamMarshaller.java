...
public class SearchXStreamMarshaller extends XStreamMarshaller {
    ...
    protected void customizeXStream(XStream xstream) {
        ...
        // This Date converter should be ok because it sets the local to english which is the wanted Locale
        xstream.registerLocalConverter(Details.class, "collectionUpdated", 
            new DateConverter(Details.getUpdateDatePatternWithoutLocal(), 
                new String[] {Details.getUpdateDatePatternWithoutLocal()}, TimeZone.getDefault()));
