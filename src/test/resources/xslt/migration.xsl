...
<xsl:output media-type="text/xml" encoding="UTF-8" method="xml" indent="yes" cdata-section-elements="cdata" />
	...
	<results>
		<xsl:for-each select="com.funnelback.publicui.search.model.padre.Result">
			<result>
				...
				<title><cdata><xsl:value-of select="title" /></cdata></title>
				...
				<summary><cdata><xsl:value-of select="summary" /></cdata></summary>
