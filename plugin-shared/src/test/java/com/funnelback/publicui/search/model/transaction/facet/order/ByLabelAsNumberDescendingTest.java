...
public class ByLabelAsNumberDescendingTest extends FacetComparatorBaseTest {
    
    @Override
    public Comparator<CategoryValue> getComparator() {
        return FacetComparators.BY_LABEL_AS_NUMBER_DESCENDING;
    }
    ...
    protected static Stream<Arguments> data() {
        ...
        return Stream.of(
            Arguments.of(Arrays.asList(cv_10, cv_1, cv_null, cv_0, cv_9), Arrays.asList(cv_10, cv_9, cv_1, cv_0, cv_null)),
