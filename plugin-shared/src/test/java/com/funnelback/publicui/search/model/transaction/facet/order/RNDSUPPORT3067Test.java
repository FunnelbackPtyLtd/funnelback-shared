...
public class RNDSUPPORT3067Test {
    ...
    public void test() throws Exception {
        ...
        values.add(new CategoryValue("a", "a", null, "", "", true, "", "", "", 0));
        values.add(new CategoryValue("a", "a", null, "", "", false, "", "", "", 0));
        values.add(new CategoryValue("a", "a", null, "", "", false, "", "", "", 0));
        values.add(new CategoryValue("a", "a", null, "", "", false, "", "", "", 0));
        values.add(new CategoryValue("a", "a", null, "", "", false, "", "", "", 0));
        values.add(new CategoryValue("a", "a", null, "", "", false, "", "", "", 0));
        ...
        values.add(new CategoryValue("a", "a", null, "", "", false, "", "", "", 0));
        values.add(new CategoryValue("a", "a", null, "", "", false, "", "", "", 0));
        values.add(new CategoryValue("a", "a", 0, "", "", true, "", "", "", 0));
        
        Collections.sort(values, 
            comparatorProvider.getComparatorWhenSortingValuesFromSingleCategory(order));
